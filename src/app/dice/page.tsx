...
const ChineseDice = () => {
  ...
  return (
    <main className="bg-gradient-to-r from-[--colors-violetAlt1] to-[--colors-violetAlt2] overflow-hidden flex justify-center py-5">
        ...
        <div className="flex gap-[10px] my-[20px] md:absolute md:top-[15px] md:gap-[260px] md:-left-[500px]">
          ...
          >
            ...
            <div className="flex flex-col absolute top-[130px] left-[20px] w-[300px] right-[15px]">
              <span className="text-7xl text-[#EE6033] font-bold text-right">
                TTT
              </span>
              ...
              <span className="bg-gradient-to-br from-[#FFBA88] to-[#EE6033] rounded-[20px] p-2 w-[107px] h-[40px] ml-auto" />
            </div>
          </div>
          <div
          ...
          >
            ...
            <div className="flex flex-col absolute top-[130px]  w-[300px] right-[5px]">
              <span className="text-7xl text-[#EE6033] font-bold text-left">
                XXX
              </span>
              ...
              <span className="bg-gradient-to-br from-[#FFBA88] to-[#EE6033] rounded-[20px] p-2 w-[107px] h-[40px] mr-auto" />
            </div>
          </div>
          <div
          ...
          >
            ...
            <div className="flex flex-col absolute top-[15px] right-[15px]">
              <span className="text-2xl text-[#EE6033] font-bold text-right">
                TTT
              </span>
              ...
              <span className="bg-gradient-to-br from-[#FFBA88] to-[#EE6033] rounded-[20px] p-2 w-[60px] h-[20px] ml-auto" />
            </div>
          </div>
          <div
            className="relative md:hidden cursor-pointer"
          ...
          >
            ...
            <div className="flex flex-col absolute top-[15px] right-[30px]">
              <span className="text-2xl text-[#EE6033] font-bold text-left">
                XXX
              </span>
              <div className="my-2 relative">
                <svg
              ...
              <span className="bg-gradient-to-br from-[#FFBA88] to-[#EE6033] rounded-[20px] p-2 w-[60px] h-[20px] mr-auto" />
            </div>
          </div>
        </div>
      </div>
