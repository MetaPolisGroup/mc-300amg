    ...
    <footer className="bg-[--colors-backgroundAlt]">
      <div className="relative container px-5 pt-14 mx-auto">
        <div className=" flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="flex-grow gap-[33px] flex flex-wrap md:flex-nowrap -mb-10 md:text-left text-center ">
          ...
          <div className="w-64 flex-shrink-0 md:mx-0 h-[200px] flex items-start justify-end md:justify-center text-center md:text-left md:mt-0 mt-10 order-first md:order-none mb-14 ">
            <svg
          ...
          <div className="md:hidden border-t-[1px] border-b-[1px] border-[#383241] mb-5 container -order-2 md:order-none md:justify-between items-center  py-10 flex md:flex-row md:flex-nowrap flex-wrap flex-col">
            <div className="md:mb-5 flex gap-5 items-center mt-5 md:w-3/6 w-full">
              ...
              {/* <div className="text-2xl text-[#ed4b9e]">EN</div> */}
            </div>
            <div className="flex items-center gap-5 order-first md:order-none justify-between  w-full md:w-[45%] lg:w-[30%]">
              ...
              <div className="text-[--colors-invertedContrast] flex w-full items-center px-5 justify-around py-1 bg-[--colors-primary] rounded-full font-bold">
        ...
        <div className="hidden mt-10 mx-auto pb-14 md:flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        ...
        {showElement && (
          <div
            className="fixed cursor-pointer right-[100px] bottom-[190px] flex w-[5%] items-center  justify-around py-3 bg-[--colors-primary] rounded-xl font-bold"
