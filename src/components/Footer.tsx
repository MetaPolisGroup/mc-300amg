  ...
  return (
    <footer className="bg-[--colors-backgroundAlt] ">
      <div className="container px-5 py-14 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="flex-grow flex flex-wrap  -mb-10 md:text-left text-center ">
        ...
        <div className="w-64 flex-shrink-0 md:mx-0  text-center md:text-left md:mt-0 mt-10 order-first md:order-none mb-14 ">
          <svg
        ...
        <div className="md:hidden border-t-[1px] border-b-[1px] border-[#383241] mb-5 container -order-2 md:order-none md:justify-between items-center  py-10 flex md:flex-row md:flex-nowrap flex-wrap flex-col">
          ...
          <div className="flex items-center gap-5 order-first md:order-none justify-between  w-full md:w-[45%] lg:w-[30%]">
            ...
            <div>
              <button className="px-8 py-2 bg-[#1fc7d4] rounded-full font-bold text-2xl">
                Buy Cake
              </button>
            </div>
          </div>
      ...
      <div className="hidden container px-6 mx-auto pb-14 md:flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
