...
const CoinCurrency: React.FC = () => {
  ...
  return (
    <div
      className="bg-[--colors-backgroundAlt] p-1 px-2 rounded-3xl text-[--colors-text] flex gap-0 items-baseline cursor-pointer flex-col rounded-br-[3rem] w-[120px] md:w-[170px] md:flex-row md:items-center md:rounded-br-3xl md:gap-2 md:p-2 md:px-3"
